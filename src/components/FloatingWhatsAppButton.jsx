...
export const FloatingWhatsAppButton = () => {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`fixed bottom-[var(--whatsapp-mobile-bottom)] right-4 z-50 inline-flex min-h-12 touch-manipulation items-center justify-center gap-2 rounded-full border border-[#25D366]/35 bg-[#25D366] px-4 py-3 text-sm font-semibold text-white shadow-[0_18px_42px_rgba(37,211,102,0.28)] transition active:scale-[0.98] hover:-translate-y-1 hover:bg-[#20BD5C] hover:shadow-[0_22px_48px_rgba(37,211,102,0.34)] sm:bottom-24 sm:right-6 sm:min-h-14 sm:px-5 ${
        isHeroFirstScreen
